...
export default async function TiendaGraciasPage({
  ...
  return (
    <main className="rescue-theme rescue-theme--green min-h-screen flex flex-col items-center justify-center text-center px-6 py-20 bg-[var(--rescue-ink)] text-white">
